...
object MIComputer {
  ...
  def main(args: Array[String]){
    println(xai.util.MutualInformation(Array(Array(0, 1), Array(1, 0))))
    println(xai.util.MutualInformation(Array(Array(1, 0), Array(1, 0))))
    println(xai.util.MutualInformation(Array(Array(99, 1), Array(1, 99))))
  }
}